	...
	proc
		...
		qotd(mob/chatter/trg)
			...
			if(server_manager.home.qotd)
				if(trg.show_colors) trg << output("<center><b>[fadeText("Developer Quote of the Day", list("255000000","000000000"))]</b>", "default_output")
				else trg << output("<center><b>Developer Quote of the Day</b>", "default_output")

				trg << output("<center><i style='font-family: Arial'>[server_manager.home.qotd]</i></center>", "default_output")
